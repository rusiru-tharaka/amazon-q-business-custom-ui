...
ui_title = os.environ.get("BEDROCK_AGENT_TEST_UI_TITLE", "DocGPT - Ai Assistant")
...
st.set_page_config(page_title="DocGPT Powered By Unionbank of the Philippines") #HTML title
st.title("DocGPT") #page title
...
# Sidebar Logo
LOGO = "docs/ubp-logo.png"
st.sidebar.image(LOGO)
st.sidebar.caption("IDocGPT. Knowledge of past board meetings at your fingertips! This Aartificial Intelligence (AI) service provides executives and board members with condensed, easy-to-review summaries of past board meeting minutes. With DocGPT, you'll have the key details, discussions, and decisions from previous meetings right at your fingertips. Easily identify relevant topics to prepare questions for upcoming board meetings.")
